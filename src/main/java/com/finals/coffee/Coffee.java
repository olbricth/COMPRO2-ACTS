...
public class Coffee {
    ...
    // Private fields to store coffee attributes
    private int id;
    private String name;
    private String type;
    private String size;
    ...
    // Constructor to initialize all fields when creating a Coffee object
    ...
    // Getter methods to retrieve each attribute value
    public int getId() {
        return id;
    }
